...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        Widget->resize(706, 332);
        Widget->setMinimumSize(QSize(706, 332));
        ...
        tableWidget->setGeometry(QRect(30, 70, 661, 231));
        tableWidget->setStyleSheet(QStringLiteral(""));
        layoutWidget = new QWidget(Widget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(30, 10, 661, 51));
        ...
        label_3->setGeometry(QRect(-9, -6, 721, 341));
        label_3->setStyleSheet(QStringLiteral("border-image: url(:/back/style/second.png);"));
        label_3->raise();
        tableWidget->raise();
        layoutWidget->raise();
